...
class AnamnesisSection:
    def __init__(self, notebook, anamnesis_tab, doctors_letter):
        self.doctors_letter = doctors_letter
        # Notebook für Tabs erstellen
        self.notebook = notebook
        self.anamnesis_tab = anamnesis_tab
        self.anamnesis_tab.pack(fill=tk.BOTH, expand=True)


    def create_anamnesis_text_tab(self):
        # Tab für Nebendiagnosetext erstellen
        self.notebook.add(self.anamnesis_tab, text="Anamnese")

        # Freitextfeld für den Nebendiagnosetext
        text_frame = ttk.LabelFrame(self.anamnesis_tab, text="Anamnese", padding=10)
    ...
    def load_initial_text(self):
        ...
        """
        initial_text = self.doctors_letter.get("anamnesis", "")
    ...
    def on_text_change(self, event):
        ...
        self.doctors_letter["anamnesis"] = new_text
        print(self.doctors_letter["anamnesis"])  # Debug-Ausgabe
